...
const sprints = [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "P3-207", name: "Sincronización de node_modules entre Docker y Local", tag: "TOOLING", color: "#5F5E5A", status: "done",
        subtasks: []
      },
      {
        id: "P3-216", name: "Reestructuración y Saneamiento del Backlog en Jira", tag: "GESTIÓN", color: "#854F0B", status: "done",
        subtasks: []
      },
      {
        id: "P3-217", name: "Corrección de Syntax Error en Suite de Tests", tag: "BUG", color: "#A32D2D", status: "done",
        subtasks: []
      },
      {
        id: "P3-234", name: "CRUD Completo de Productos (Inventario)", tag: "CORE", color: "#0F6E56", status: "done",
        subtasks: [
          { id: "P3-270", name: "Implementación de endpoints POST, PUT y DELETE para productos", status: "done" },
          { id: "P3-271", name: "Desarrollo de formularios y lógica de creación/edición (Modales)", status: "done" },
          { id: "P3-272", name: "Lógica de validación de negocio y manejo de errores CRUD", status: "done" },
        ]
      },
      {
        id: "P3-235", name: "Gestión Integral de Categorías", tag: "CORE", color: "#0F6E56", status: "done",
        subtasks: [
          { id: "P3-273", name: "Endpoints CRUD completos para la entidad Category", status: "done" },
          { id: "P3-274", name: "Interfaz de gestión de categorías (Listado y Operaciones)", status: "done" },
          { id: "P3-275", name: "Implementación de integridad referencial (Protección de borrado)", status: "done" },
        ]
      },
      {
        id: "P3-236", name: "CRUD de Usuarios y Gestión de Roles", tag: "CORE", color: "#0F6E56", status: "warning",
        subtasks: [
          { id: "P3-276", name: "Implementación de la tabla User y endpoints CRUD base", status: "warning" },
          { id: "P3-277", name: "Vista de administración de usuarios y asignación de roles", status: "done" },
          { id: "P3-278", name: "Lógica de validación de perfiles (Emails únicos)", status: "warning" },
        ]
      },
      {
        id: "P3-238", name: "Automatización de Calidad con GitHub Actions", tag: "DEVOPS", color: "#185FA5", status: "done",
        subtasks: [
          { id: "P3-281", name: "Configuración de Workflow CI (.yml) para el Backend (Pytest)", status: "done" },
          { id: "P3-282", name: "Configuración de Workflow CI para el Frontend (Lint/Build)", status: "done" },
        ]
      },
      {
        id: "P3-239", name: "Sesión de Formación Técnica y Code Review", tag: "ARQ", color: "#534AB7", status: "done",
        subtasks: [
          { id: "P3-279", name: "Preparación del material didáctico sobre flujo CRUD y Arquitectura", status: "done" },
          { id: "P3-280", name: "Impartición de la sesión práctica y Live Coding para el equipo", status: "done" },
        ]
      },
      {
      ...
      {
        id: "P3-246", name: "RoadMap del Proyecto y Cronograma de Entregas", tag: "GESTIÓN", color: "#854F0B", status: "done",
        subtasks: []
      },
    ],
  },
  ...
  if (status === "done") return (
    <div style={{
      ...
      <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
        <path d="M2 5L4.5 7.5L8 3" stroke="#9FE1CB" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
  return (
    <div style={{
      width: 18, height: 18, borderRadius: "50%",
      background: "#412402", border: "1.5px solid #BA7517",
      display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
    }}>
      <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "2.5rem" }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, color: "var(--color-text-primary)", margin: 0, letterSpacing: "-0.5px" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        {sprints.map((sprint, i) => {
          ...
          return (
            <div key={sprint.id} style={{ position: "relative", marginBottom: i < sprints.length - 1 ? 32 : 0 }}>
              <div style={{
                ...
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <path d="M2.5 6L5 8.5L9.5 3.5" stroke={sc.text} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <span style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 13, fontWeight: 500, color: sc.border }}>
                      {sprint.name}
                    </span>
                    <span style={{
                  ...
                  <span style={{ fontSize: 12, color: "var(--color-text-tertiary)", fontFamily: '"JetBrains Mono", monospace', whiteSpace: "nowrap" }}>
                    {sprint.dates}
                  </span>
                </div>

                <p style={{ fontSize: 15, fontWeight: 600, color: "var(--color-text-primary)", margin: "8px 0 0" }}>
                  {sprint.focus}
                </p>
                        ...
                        <div key={task.id}>
                          <div
                            ...
                            style={{
                              ...
                              padding: "8px 12px",
                              background: task.status === "warning" ? "#41240210" : "var(--color-background-primary)",
                              borderRadius: 8,
                          ...
                          >
                            ...
                            <span style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 11, color: "var(--color-text-tertiary)", minWidth: 52 }}>
                              {task.id}
                            </span>
                            <span style={{
                            ...
                            <span style={{ fontSize: 13, color: "var(--color-text-primary)", fontWeight: 400, flex: 1 }}>
                              {task.name}
                            </span>
                            {hasSubtasks && (
                            ...
                            <div style={{ marginLeft: 24, marginTop: 4, display: "flex", flexDirection: "column", gap: 4 }}>
                              {task.subtasks.map(sub => (
                                <div key={sub.id} style={{
                                  ...
                                  padding: "6px 10px",
                                  background: sub.status === "warning" ? "#41240210" : "var(--color-background-primary)",
                                  borderRadius: 6,
