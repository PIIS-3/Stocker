    ...
    <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        <ul className="flex flex-wrap justify-center gap-6 mb-8 text-sm text-gray-400">
          <li><Link to="/privacy" className="hover:text-brand transition-colors">Política de Privacidad</Link></li>
          <li><Link to="/terms" className="hover:text-brand transition-colors">Términos de Servicio</Link></li>
